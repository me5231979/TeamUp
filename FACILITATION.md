...
(3) a **validation point**. Every 20 to 25 minute block completes a full Kolb
...
**Pre-work (5 to 7 days prior, ~20 min):** the 2-page Edmondson excerpt, the
7-item baseline self-score, the 5 to 6 adjective pre-select from the standard
...
**Affective arc:** the Johari block is the emotional peak; Sections 05 to 06
